# 🎮 Just doing another logic test (updated)
...
## 💡 Next
- Fix bugs character still can got through wall if using diagonal movement. (If im not lazy) (Done)
- Control for some touchscreen, like mobile or tab. (Progress)
